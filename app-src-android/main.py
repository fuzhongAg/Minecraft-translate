...
THEME = {
    ...
    "card": (1, 1, 1, 1),
    "fg": (0.15, 0.15, 0.15, 1),
    "accent": (0.25, 0.62, 0.20, 1),
    "warn": (0.95, 0.55, 0.15, 1),
    "gold": (0.25, 0.62, 0.20, 1),
    "hint": (0.40, 0.40, 0.40, 1),
}
...
class MainLayout(ScrollView):
    ...
    def _build_ui(self):
        ...
        settings_card.add_widget(self._section_title("翻译设置"))

        settings_card.add_widget(self._hint("目标类型"))
        ...
        settings_card.add_widget(self._hint("输出模式"))
        ...
        settings_card.add_widget(self._hint("翻译引擎"))
        ...
        settings_card.add_widget(self._hint("翻译模式"))
        ...
        log_card.add_widget(self._section_title("运行日志"))
